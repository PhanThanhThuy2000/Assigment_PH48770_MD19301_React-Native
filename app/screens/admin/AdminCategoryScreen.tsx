    ...
    const fetchData = async () => { //gọi API mà không làm ứng dụng bị đơ
        try {
            ...
            const response = await axios.get<Categories[]>( //Categories[] kiểu dữ liệu đã khai báo ở trên
                "https://67b6ce1507ba6e590841d413.mockapi.io/categories"
            );
    ...
    const handleSave = async () => {
        ...
        try {
            if (editingCategories) {
                ...
                await axios.put(`https://67b6ce1507ba6e590841d413.mockapi.io/categories/${editingCategories.id}`, {
                    name: nameCategories,
                });

            } else {
                // Gửi yêu cầu tạo danh mục mới
                await axios.post("https://67b6ce1507ba6e590841d413.mockapi.io/categories", {
                    name: nameCategories,
                });
            }
    ...
    const handleDelete = async (id: number) => {
        Alert.alert("Xác nhận xóa", "Bạn có chắc chắn muốn xóa danh mục này không?", [
            { text: "Hủy", style: "cancel" },
            {
                ...
                onPress: async () => {
                    try {
                        await axios.delete(`https://67b6ce1507ba6e590841d413.mockapi.io/categories/${id}`);
